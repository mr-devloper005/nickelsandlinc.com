...
const inputClass = 'h-12 rounded-sm border border-black/10 bg-[var(--slot4-surface-bg)] px-4 text-base font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-muted-text)] focus:border-current'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-sm bg-[var(--slot4-accent-fill)] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:bg-[var(--slot4-accent)] disabled:opacity-60'
